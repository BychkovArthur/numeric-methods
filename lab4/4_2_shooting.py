...
def Shooting(xs, y0, h, eps):
    '''
        ...
        где η- некоторое значение тангенса угла наклона касательной крешению в точкеa x=a.
    ...
    while True:
        ...
        # Для решения краевой задачи много раз решаем задачу Коши методом РК

        # По методу секущих находим следующую η
